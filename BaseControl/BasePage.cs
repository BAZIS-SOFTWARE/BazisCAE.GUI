...
namespace BaseControl
{
    public partial class BasePage : UserControl
    {
        ...
        public Console.ConsoleControl ConsoleControl
        {
            get
            {
...
"GMSH(*.inp*)|*.inp";
        ...
        private void BasePage_Load(object sender, EventArgs e)
        {
            ...
            standartToolStrip.Renderer = new BtnToolStrRender();
            standartToolStrip.ItemClicked += StandartToolStrip_ItemClicked;

            selectToolStrip.Renderer = new BtnToolStrRender();
            ...
            displayToolStrip.Renderer = new BtnToolStrRender();
            displayToolStrip.ItemClicked += DisplayToolStrip_ItemClick;

            viewToolStrip.Renderer = new BtnToolStrRender();
            viewToolStrip.ItemClicked += ViewToolStrip_ItemClicked;

            instrumentalToolStrip.Renderer = new BtnToolStrRender();
