...
namespace BaseModule.PropertiesPanel
{
    public class RowProperty //: DataGridViewRow // Свойства строки
    {
        ...
        public RowProperty(string header, DataGridViewCell initialization, SequenceType sequence, ValidationType validationType = ValidationType.None, bool isReadOnly = false, bool isDropDown = false, List<string> availableValues = null)
        {
            Header = header;
            //Value = value;
