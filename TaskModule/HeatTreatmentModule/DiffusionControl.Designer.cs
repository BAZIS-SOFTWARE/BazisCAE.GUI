...
namespace TaskModule.HeatTreatmentModule
{
    partial class DiffusionСontrol
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txbStop = new TextBoxEx() { InputType = TXTBoxInputType.Float | TXTBoxInputType.Positive };
            this.txbStart = new TextBoxEx() { InputType = TXTBoxInputType.Float | TXTBoxInputType.Positive };
            this.label6 = new System.Windows.Forms.Label();
            this.label5 = new System.Windows.Forms.Label();
            this.groupBox2 = new System.Windows.Forms.GroupBox();
            this.txbDiffCoefNitro = new TextBoxEx() { InputType = TXTBoxInputType.Float | TXTBoxInputType.Positive };
            this.label9 = new System.Windows.Forms.Label();
            this.txbConcentrNitro = new TextBoxEx() { InputType = TXTBoxInputType.Float | TXTBoxInputType.Positive };
            this.txbConcentrCarbon = new TextBoxEx() { InputType = TXTBoxInputType.Float | TXTBoxInputType.Positive };
            this.label8 = new System.Windows.Forms.Label();
            this.rbtFunction = new System.Windows.Forms.RadioButton();
            this.rbtParam = new System.Windows.Forms.RadioButton();
            this.cmbEl = new ComboBoxEx();
            this.cmbTempreture = new ComboBoxEx() { InputType = CMBInputType.Items | CMBInputType.Float };
            this.txbDiffCoefCarbon = new TextBoxEx() { InputType = TXTBoxInputType.Float | TXTBoxInputType.Positive };
