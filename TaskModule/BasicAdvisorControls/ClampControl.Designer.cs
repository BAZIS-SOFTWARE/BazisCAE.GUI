...
namespace TaskModule.BasicAdvisorControls
{
    partial class ClampControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnRefresh = new CheckValidatingButton(this.components);
            this.btnAddNewRow = new CheckValidatingButton(this.components);
            this.txbStartTime = new ValidatingNumericTextBox(this.components);
            this.cmbNodeGr = new ValidatingCMB(this.components);
            this.cmbKind = new ValidatingCMB(this.components);
